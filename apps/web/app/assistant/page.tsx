...
export default function AssistantPage() {
  ...
  function speak(text: string) {
    ...
    utterance.onstart = () => {
      setSpeaking(true);
      setStatus("?? Sweety AI is speaking...");
    };
  ...
  async function askSweety(voiceMessage?: string) {
    ...
    if (loadingRef.current) {
      console.log("MESSAGE BLOCKED: AI is already processing.");
      return;
    }
    ...
    setLoading(true);
    setStatus("?? Sweety AI is thinking...");
  ...
  return (
    ...
    >
      ...
      >
        <h1>Sweety AI Ultimate</h1>

        <p>Full Voice Command Assistant</p>
        ...
        >
          <textarea
            ...
            placeholder="Speak or type to Sweety AI..."
            rows={5}
            disabled={loading}
            style={{
              width: "100%",
